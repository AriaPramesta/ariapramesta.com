      ...
      <div className="block md:hidden mx-5 mb-64" id="contactMobile">
        ...
        <div className="flex justify-evenly">
          <a
            ...
            target="blank"
          >
            <div className=" w-36 bg-black px-5 py-5 rounded-2xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 shadow-lg shadow-stone-700">
