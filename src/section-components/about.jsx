...
export default function About() {
  return (
    <div>
      <p className="text-center opacity-40 -mr-20 xl:-mr-64 md:mb-24 md:mt-10">
        Only Human
      </p>
      <div>
        <h1 className="md:text-lg xl:text-xl mb-5 md:mb-28 lg:ml-20">
          My Skills
        </h1>
        <div className="grid grid-cols-2 gap-4 md:gap-14 lg:gap-24 sm:grid-cols-3 md:grid-cols-4">
          {skills.map((skill, index) => (
            ...
            >
              ...
              <span className="md:text-sm text-center">{skill.title}</span>
            </div>
          ))}
        </div>
      </div>
